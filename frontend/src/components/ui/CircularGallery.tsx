...
class GalleryApp {
  ...
  onCheck() {
    ...
    if (this.onActiveChange) {
      ...
      this.onActiveChange(itemIndex % originalLength);
    }
  }
  onResize() {
    this.screen = {
...
export default function CircularGallery({
  ...
  useEffect(() => {
    ...
    resolveFont(font, fontUrl).then(resolvedFont => {
      ...
      app.onActiveChange = onActiveChange;
      if (onActiveChange) onActiveChange(0);
    });
    return () => {
      isMounted = false;
      if (app) app.destroy();
    };
  }, [items, bend, textColor, borderRadius, font, fontUrl, scrollSpeed, scrollEase, onActiveChange]);
